...
// Data Members.
   ...
   TOtherData();
   TOtherData(TOtherData && ) = default;
   TOtherData &operator=(const TOtherData & );
...
// Data Members.
   ...
   TBeamSummaryData();
   TBeamSummaryData(TBeamSummaryData && ) = default;
   TBeamSummaryData &operator=(const TBeamSummaryData & );
