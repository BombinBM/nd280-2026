...
#ifndef ND__TGlobalReconModule__THATPID_h
#define ND__TGlobalReconModule__THATPID_h
namespace ND {
...
// Data Members.
   ...
   TVector3       TrackDirection;      //The direction of the track as in hatReconTreeMaker
   TVector3       TrackPosition;       //The position of the track as in hatReconTreeMaker
   double         TrackMomentum;       //The fabs of momentum of the track as in hatReconTreeMaker
   int            TrackCharge;         //The charge of the track as in hatReconTreeMaker
   double         TrackdEdx_WF;        //The dEdx_WF of the track as in hatReconTreeMaker
   ...
   THATPID();
   THATPID(THATPID && ) = default;
   THATPID &operator=(const THATPID & );
   THATPID(const THATPID & );
   virtual ~THATPID();

   ClassDef(THATPID,2); // Generated by MakeProject.
};
} // namespace
} // namespace
#endif
