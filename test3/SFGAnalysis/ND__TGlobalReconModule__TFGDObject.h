...
// Data Members.
   ...
   vector<TLorentzVector> NodePosition;                   //FGD Node positions
   vector<double>         NodeEDeposit;                   /// FGD Node Energy Deposits

   TFGDObject();
   TFGDObject(TFGDObject && ) = default;
   TFGDObject &operator=(const TFGDObject & );
   TFGDObject(const TFGDObject & );
   virtual ~TFGDObject();

   ClassDef(TFGDObject,4); // Generated by MakeProject.
};
} // namespace
} // namespace
#endif
